    ...
    return (
        <div className="min-h-screen flex flex-col md:grid md:grid-cols-2">
            ...
            <div className="relative bg-ink flex flex-col justify-between p-6 md:p-12 overflow-hidden min-h-[260px] md:min-h-0 w-full">
                ...
                <div className="relative z-10 rounded-xl p-5 hidden md:block" style={{ background: "rgba(255,255,255,0.04)", borderColor: "rgba(255,255,255,0.08)" }}>
            ...
            <div className="flex items-center justify-center px-6 py-12 bg-cream">
                <div className="w-full max-w-md">
                    ...
                    <h2 className="font-serif text-3xl text-ink mb-1">Start for free</h2>
                    <p className="text-sm font-sans text-ink-3 mb-8">Your AI receptionist is 5 minutes away</p>
                    <div className="bg-white border border-border rounded-xl p-8">
                        <form onSubmit={handleSignup} className="space-y-4">
                            <div>
                                <label className="block text-2xs font-sans font-500 text-ink mb-1.5 tracking-[0.12em] uppercase">Full name</label>
                        ...
                        <p className="text-center text-xs font-sans text-ink-3">
                            ...
                            <Link href="/login" className="text-gold hover:text-gold-dark font-500 transition-colors">Sign in</Link>
                        </p>
                        <p className="text-center text-2xs font-sans text-ink-3 mt-3">
